export default {
  ...
  help: {
    ...
    aboutTitle: "What is Quick Notion?",
    aboutBody:
      "Quick Notion is an app that quickly sends text to your Notion databases. Jot down tasks and notes without opening Notion.",
    ...
    titlePropBody:
      "Every Notion database has one Title-type property. Quick Notion writes text to this property.",
    titlePropBody2:
